...
QT_MOC_LITERAL(4, 36, 19) // "on_btSignin_clicked"

    },
    "LoginView\0loginSuccess\0\0loginFailed\0"
    "on_btSignin_clicked"
};
...
void LoginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginView::loginSuccess)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginView::loginFailed)) {
                *result = 1;
                return;
            }
        }
