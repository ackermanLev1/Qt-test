...
public:
    ...
    void setupUi(QWidget *MasterView)
    {
        ...
        MasterView->resize(698, 600);
        MasterView->setMaximumSize(QSize(16777215, 16777215));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/img/loop.png"), QSize(), QIcon::Normal, QIcon::Off);
        btBack->setIcon(icon);
    ...
    void retranslateUi(QWidget *MasterView)
    {
        ...
        labelTitle->setText(QApplication::translate("MasterView", "<html><head/><body><p><br/></p></body></html>", nullptr));
